...
<html>
	...
	<body class="homepage is-preload">
		<div id="page-wrapper">
			...
			<!-- write -->
				<form action="SBoardAction.jsp" method="post">
<div class="container">
<table class="table table-bordered">
    ...
    <tbody>
            ...
            <tr>
                <th> 제목: </th>
                <td><input type="text" placeholder="제목을 입력하세요. " name="stuTitle" class="form-control" maxlength ="50"/></td>
            </tr>
            <tr>
                <th> 내용: </th>
                <td><textarea cols="200" placeholder=" 내용을 입력하세요. " name="stuContent" class="form-control" maxlength ="2048"></textarea></td>
            </tr>
				<th>파일 첨부: </th>
